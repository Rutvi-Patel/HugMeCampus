...
import com.diamondTierHuggers.hugMeCampus.placeholder.PlaceholderContent.PlaceholderItem;
...
public class MyListItemRecyclerViewAdapter extends RecyclerView.Adapter<MyListItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyListItemRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
